...
export const encoder = (scheme = NL2000) => input => convert(0x100, scheme.length, [...input]).map(i => scheme[i]).join('');
export const decoder = (scheme = NL2000) => input => convert(scheme.length, 0x100, [...input].map(c => scheme.indexOf(c)));
